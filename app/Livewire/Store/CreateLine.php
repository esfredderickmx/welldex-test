...
class CreateLine extends Component {
  ...
  public function render() {
    return view('livewire.store.create-line');
  }

  public function storeLine() {
    $this->validate();

    $created_terminal = ShippingLine::create($this->all());
    $created_terminal->address()->save(Address::create($this->all()));

    $this->resetForm();

    $this->dispatch('show-message', message: 'Naviera añadida correctamente.', type: 'success', modal: 'create-line');
  }
