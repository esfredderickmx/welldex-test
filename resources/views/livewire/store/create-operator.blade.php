<div>
  @teleport('body')
  <div class="ui tiny modal" modal="create-operator" wire:ignore.self>
    <div class="ui top attached blue inverted segment">
      <div class="ui large header">Añadir operador</div>
    </div>
    <div class="ui attached segment content">
      <form id="storeOperator" class="ui form" wire:submit="storeOperator" wire:loading.class="loading" wire:target="storeOperator">
    ...
    <div class="ui bottom attached segment actions">
      <button form="storeOperator" type="submit" class="ui labeled icon primary button" wire:loading.class="disabled" wire:target="storeOperator">
        <i class="check icon" wire:loading.class="loading spinner" wire:target="storeOperator"></i>Añadir operador
      </button>
      <button wire:click="resetForm" form="storeOperator" type="reset" class="ui cancel button" wire:loading.class="loading" wire:target="resetForm">Cancelar</button>
    </div>
  </div>
  @endteleport
</div>