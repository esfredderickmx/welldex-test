<div>
  @teleport('body')
  <div class="ui tiny modal" modal="create-provider" wire:ignore.self>
    <div class="ui top attached blue inverted segment">
      <div class="ui large header">Añadir proveedor</div>
    </div>
    <div class="ui attached segment content">
      <form id="storeProvider" class="ui form" wire:submit="storeProvider" wire:loading.class="loading" wire:target="storeProvider">
    ...
    <div class="ui bottom attached segment actions">
      <button form="storeProvider" type="submit" class="ui labeled icon primary button" wire:loading.class="disabled" wire:target="storeProvider">
        <i class="check icon" wire:loading.class="loading spinner" wire:target="storeProvider"></i>Añadir proveedor
      </button>
      <button wire:click="resetForm" form="storeProvider" type="reset" class="ui cancel button" wire:loading.class="loading" wire:target="resetForm">Cancelar</button>
    </div>
  </div>
  @endteleport
</div>