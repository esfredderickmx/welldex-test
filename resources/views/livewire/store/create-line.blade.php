<div>
  @teleport('body')
  <div class="ui tiny modal" modal="create-line" wire:ignore.self>
    <div class="ui top attached blue inverted segment">
      <div class="ui large header">Añadir naviera</div>
    </div>
    <div class="ui attached segment content">
      <form id="storeLine" class="ui form" wire:submit="storeLine" wire:loading.class="loading" wire:target="storeLine">
    ...
    <div class="ui bottom attached segment actions">
      <button form="storeLine" type="submit" class="ui labeled icon primary button" wire:loading.class="disabled" wire:target="storeLine">
        <i class="check icon" wire:loading.class="loading spinner" wire:target="storeLine"></i>Añadir naviera
      </button>
      <button wire:click="resetForm" form="storeLine" type="reset" class="ui cancel button" wire:loading.class="loading" wire:target="resetForm">Cancelar</button>
    </div>
  </div>
  @endteleport
</div>